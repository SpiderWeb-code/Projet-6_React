...
//RENDER
return(
    <div style={{padding:"0px 100px 0px 100px", display:"flex", justifyContent:"center", alignItems:"center"}}>
        <h1 style={{display:"flex", position:"absolute", fontSize:"40px", color:"white"}}>Chez vous, partout et ailleurs</h1>
